...
@ConditionalOnProperty(prefix = "tcp", name = "enable", havingValue = "true", matchIfMissing = false)
    ...
    public void start() {
        ...
        try {
            ...
            serverBootstrap.group(bossGroup, workGroup) //设置线程组
                    ...
                    .childHandler(tcpServerInitializer)// 给workGroup的EventLoop对应的管道设置处理器
            ;
        ...
        log.info("tcp server started in " + serverPort);
    }
