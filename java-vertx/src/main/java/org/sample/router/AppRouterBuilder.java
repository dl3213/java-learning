...
public class AppRouterBuilder {
    public static Router build(Router router) {
        ...
        router.get("/api/v1/router/get").respond(context -> Future.succeededFuture(Response.success("get")));
        router.post("/api/v1/router/post").respond(context -> Future.succeededFuture(Response.success("post")));
