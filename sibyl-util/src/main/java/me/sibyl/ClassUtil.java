...
import me.sibyl.test.EnumInterface;
...
public class ClassUtil {
    ...
    public static ArrayList<Class> getAllClassByInterface(Class clazz) {
        ...
        if (clazz.isInterface()) {
            try {
                ...
                for (int i = 0; i < allClass.size(); i++) {
                    ...
                    if (clazz.isAssignableFrom(allClass.get(i))) { // 子类继承或接口实现都有效
        ...
        System.err.println("class list size :" + list.size());
        return list;
    }
    ...
    private static ArrayList<Class> getAllClass(String packagename) {
        ...
        System.err.println();
        System.err.println("packageName to search：" + packagename);
